    ...
    <nav className="bg-white shadow-md fixed w-full z-50 top-0 left-0">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          {/*  LOGO SECTION WITH INKFLOW FEATHER ICON */}
          <div className="flex-shrink-0">
            <Link to="/" className="flex items-center space-x-2 text-xl font-extrabold text-indigo-600 tracking-tight group">
              {/* Modern Feather Pen SVG Icon */}
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
                className="w-6 h-6 text-indigo-600 transition-transform duration-300 group-hover:rotate-12"
              >
                <path d="M21.731 2.269a2.625 2.625 0 00-3.712 0l-1.157 1.157 3.712 3.712 1.157-1.157a2.625 2.625 0 000-3.712zM19.513 8.199l-3.712-3.712-12.15 12.15a5.25 5.25 0 00-1.32 2.214l-.8 2.685a.75.75 0 00.933.933l2.685-.8a5.25 5.25 0 002.214-1.32L19.513 8.2z" />
              </svg>
              <span>
                Ink<span className="text-slate-800 font-medium">Flow</span>
              </span>
            </Link>
          </div>
          ...
          <div className="hidden md:flex space-x-8 font-medium text-gray-700">
            ...
            <Link to="/blogs" className="hover:text-indigo-600 transition duration-200">Blog</Link>
      ...
      {isOpen && (
        <div className="md:hidden bg-white border-t border-gray-100">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 font-medium text-gray-700">
            ...
            <Link to="/blogs" onClick={() => setIsOpen(false)} className="block px-3 py-2 rounded-md hover:text-indigo-600 hover:bg-gray-50">Blog</Link>
